...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.43.123"), 12124)}, "C:\\Users\\abedx\\Desktop\\iOS\\abedtabs\\abedtabs.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("abedtabs");
}
}
}
